...
window.NAS_I18N.en = {
  ui: {
    ...
    smartDetail: {
      titleFor: "Status for {name}",
      overallHealth: "Overall self-test result",
      passed: "OK (PASSED)",
      failed: "FAILED",
      temperature: "Temperature",
      powerOnHours: "Power-on time",
      reallocatedSectors: "Reallocated sectors",
      reportedUncorrect: "Reported uncorrectable errors",
      commandTimeout: "Command timeouts",
      pendingSectors: "Pending sectors",
      offlineUncorrectable: "Offline uncorrectable errors",
      mediaErrors: "Media errors (NVMe)",
      percentageUsed: "Drive wear used (NVMe, %)",
      criticalWarning: "Critical warning (NVMe)",
      unsafeShutdowns: "Unsafe shutdowns (NVMe)",
    },
    raidRepairDialog: {
      title: "Repair array",
    ...
    summary: {
      ...
      networkTitle: "Main connection",
      throughput: "Throughput",
    },
    rawDisks: {
      heading: "Manage disks",
      subtitle: "Every disk, including the system one - format, wipe, unmount, or check status, regardless of whether it's currently in use.",
      colName: "Name",
      colLabel: "Label",
      colSize: "Size",
      colModel: "Model",
    ...
    network: {
      ...
      hostname: "Hostname",
      editHostnameBtn: "Edit",
      saveHostnameBtn: "Save",
      cancelHostnameBtn: "Cancel",
  ...
  err: {
    ...
    network: {
      ...
      invalid_hostname: "Invalid hostname (letters, digits, and hyphens only, no leading/trailing hyphen, 63 characters max)",
    },
    log: {
