...
window.NAS_I18N.en = {
  ui: {
    ...
    certs: {
      ...
      keyPresent: "yes",
      keyAbsent: "none",
      loginDisabledHint: "This account has login/SSH disabled - enable it first in the user's edit screen",
    ...
    addUserDialog: {
      ...
      allowLoginLabel: "Allow system/SSH login (usually NOT for share-only accounts)",
      cancelBtn: "Cancel",
      createBtn: "Create",
      saveBtn: "Save changes",
    },
  ...
  msg: {
    ...
    confirmCreateUserWithLogin: "Create user \"{name}\"{note} with login/SSH access?",
    confirmCreateUserNoLogin: "Create user \"{name}\"{note} without login access (SMB only)?",
