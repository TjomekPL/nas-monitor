...
window.NAS_I18N.pl = {
  ...
  msg: {
    ...
    deleteGroupWarning: "Uwaga: {count} członków straci dostęp wynikający z tej grupy, a udziały z niej korzystające ({shares}) stracą to powiązanie.",
    ...
    confirmMountDisk: "Zamontować {name}? Doda wpis w /etc/fstab (przez UUID) i udostępni istniejący system plików pod /srv/<nazwa>.",
    mountedDisk: "Zamontowano {name} pod {path}.",
    unmountedDisk: "Odmontowano {name}.",
    unmountBlockedWarning: "Uwaga: ten dysk ma aktywne udziały ({shares}) - odmontowanie się nie powiedzie, dopóki ich nie usuniesz lub przeniesiesz.",
