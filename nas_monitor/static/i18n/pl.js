...
window.NAS_I18N.pl = {
  ui: {
    ...
    certs: {
      ...
      keyPresent: "jest",
      keyAbsent: "brak",
      loginDisabledHint: "To konto ma wyłączone logowanie/SSH - włącz je najpierw w edycji użytkownika",
    ...
    addUserDialog: {
      ...
      allowLoginLabel: "Zezwól na logowanie do systemu / SSH (zwykle NIE dla kont udostępniania)",
      cancelBtn: "Anuluj",
      createBtn: "Utwórz",
      saveBtn: "Zapisz zmiany",
    },
  ...
  msg: {
    ...
    confirmCreateUserWithLogin: "Utworzyć użytkownika \"{name}\"{note} z możliwością logowania/SSH?",
    confirmCreateUserNoLogin: "Utworzyć użytkownika \"{name}\"{note} bez możliwości logowania (tylko SMB)?",
